	...
	<form id="J_form" action="javascript:C.submitForm({});" method="post">
		<table class="c_form">
			<tr>
				<th>id：</th>
				<td>
					<input type="text" class="text-input" name="id" value="<?php echo ($data["id"]); ?>" readonly>
				</td>
			</tr>
			<tr>
				<th>父节点id：</th>
				<td>
					<input type="text" class="text-input" name="pid" value="<?php echo ($data["pid"]); ?>">
				</td>
			</tr>
			<tr>
				<th>节点名称：</th>
				<td>
					<input type="text" class="text-input" name="node_name" value="<?php echo ($data["node_name"]); ?>">
				</td>
			</tr>
			<tr>
				<th>排序：</th>
				<td>
					<input type="text" class="text-input" name="sort"  value="<?php echo ($data["sort"]); ?>">
				</td>
			</tr>
			<tr>
				<th>节点说明：</th>
				<td>
					<input type="text" class="text-input w400" name="detail" value="<?php echo ($data["detail"]); ?>">
				</td>
			</tr>
			<tr>
				<th></th>
